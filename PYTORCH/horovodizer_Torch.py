...
def horovodize(path):
    ...
    # Adapt data loaders (using data samplers)
    ...
    name = "horovodized_" + ntpath.basename(path)

    # Generate new python code
    generate_horovodized_code(root_node=node, filename=name)
